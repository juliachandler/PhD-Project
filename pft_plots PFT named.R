...
tiff(file = "C:/R/2016_1/out/pft_essf_over_time2.tiff", 
...
legend(
  x="topleft", y= null,
  c("Conifers", "Semi-shade tolerant gap specialists", "Shade intolerant gap specialists",
    "Deciduous trees and tall shrubs", "Surface water specialists", "Deep shade specialists",
    "Shade tolerant herbs", "Ericaceous shrubs"),
  cex=0.7, pch=plotchar, lty=linetype, col="black", pt.bg=ptbackground, pt.cex=1.25)
dev.off()
...
tiff(file = "C:/R/2016_1/out/pft_ich_over_time2.tiff", 
     width = 4650, height = 3000, units = "px", res = 600, compression="lzw")
...
tiff(file = "C:/R/2016_1/out/pft_sbs_over_time2.tiff", 
     width = 4650, height = 3000, units = "px", res = 600, compression="lzw")
