...
pie(slices,labels = lbls, col=cols, cex=1, main="Plant Functional Types in the ESSF (Year 1)")
...
lbls <- paste(lbls, pct) # add percents to labels 
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie(slices,labels = lbls, col=cols, cex=1, main="Plant Functional Types in the ESSF (Year 20)")
...
lbls <- paste(lbls, pct) # add percents to labels 
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie(slices,labels = lbls, col=cols, cex=1, main="Plant Functional Types in the ICH (Year 1)")
...
lbls <- paste(lbls, pct) # add percents to labels 
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie(slices,labels = lbls, col=cols, cex=1, main="Plant Functional Types in the ICH (Year 20)")
...
lbls <- paste(lbls, pct) # add percents to labels 
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie(slices,labels = lbls, col=cols, cex=1, main="Plant Functional Types in the SBS (Year 1)")
...
lbls <- paste(lbls, pct) # add percents to labels 
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie(slices,labels = lbls, col=cols, cex=1, main="Plant Functional Types in the SBS (Year 20)")
